...
def get_resources(headers, repository, runId):

    version_url = PRISMA_CLOUD_URL + "bridgecrew/api/v2/errors/code_review_scan/resources"
...
def main(repository, runId):
    ...
    print(get_resources(headers, repository, runId))
